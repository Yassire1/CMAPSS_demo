...
\author[Yassire Ammouri]{\textbf{Yassire Ammouri}}
\institute[École d'Ingénieurs]{SUPMTI Rabat -- Projet de Fin de Module}
\date{2025--2026}
...
\begin{enumerate}
    ...
    \item \textbf{Entrainer} et comparer deux approches data-driven :
    \begin{itemize}
...
\begin{itemize}
    \item Taux initial : 0.001
    \item Réduction à 0.0001 après 5 époques
\end{itemize}
\vspace{0.2cm}
\textbf{Partition :}
\begin{itemize}
...
Temps d'entraînement & Quelques secondes & environ 100 secondes \\
